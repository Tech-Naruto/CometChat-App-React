...
import type { IMouseEvent,
  IActiveChatChanged,
  IGroupMemberKickedBanned,
  IGroupMemberAdded,
  IGroupMemberJoined,
  IMessages,} from '@cometchat/chat-uikit-react';
...
function CometChatHome({ defaultUser, defaultGroup, showGroupActionMessages }: CometChatHomeProps) {
    ...
    const attachSDKGroupListenerForDetails = () => {
      ...
      CometChat.addGroupListener(
        ...
        new CometChat.GroupListener({
          ...
          onGroupMemberLeft: ( group: CometChat.Group) => {
            ...
            {actionItems.map((actionItem, index) =>
              actionItem.isAllowed() ? (
                <div
                  ...
                  className={`side-component-content__action-item ${appState.isFreshChat && actionItem.id === 'deleteChat' ? 'side-component-content__action-item-disabled' : ''}`}
                  onClick={() => {
